...
namespace Udp
{
    public class UdpHost : MonoBehaviour
    {
        ...
        protected Int32 _hostPort = 5013;
        protected string _hostIp = "10.209.182.189";
        [Header("Client settings")]
        protected Int32 _clientPort = 5011;
        protected string _clientIp = "10.209.181.76";
        ...
        public virtual void SendMsg(string msg)
        {
            ...
            {
                Debug.Log("Not connected, can't send a message");
            }
        }
        ...
        protected virtual void ExecuteHost()
        {
            try
            {
                ...
                if (_connected)
                {
                    ...
                    playerNetworkController.SendHost();
                }
            ...
            catch (SocketException e)
            {
                ...
                {
                    string msg = "Client with ip " + _clientIp + " and port " + _clientPort + " is unreachable, error code " + e.ErrorCode;
